...
{
    public partial class FormGoodsGuest : Form
    {
        public FormGoodsGuest()
        {
            InitializeComponent();
        }

        private void FormGoodsGuest_Load(object sender, EventArgs e)
        {
            LoadGoods();
        }
        ...
        private void DataGridViewGoods_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            ...
            else if (column.Name == "ImgCol")
            {
                ...
                if (!string.IsNullOrEmpty(fotoPath) && File.Exists(fotoPath))
                    ...
                    img = Properties.Resources.picture; // fallback
